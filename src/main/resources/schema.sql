...
(
    ...
    CONSTRAINT "FK_TB_MEMBER_TO_TB_BOARD_1" FOREIGN KEY ("MEMBER_ID") REFERENCES "TB_MEMBER" ("MEMBER_ID")
);
...
(
    ...
    CONSTRAINT "FK_TB_MEMBER_TO_TB_FOLLOW_2" FOREIGN KEY ("CLICKED_MEMBER_ID") REFERENCES "TB_MEMBER" ("MEMBER_ID") ON DELETE CASCADE
);

CREATE TABLE "TB_BLOG"
(
    "MEMBER_ID" NUMBER                  NOT NULL,
    "INTRODUCE" VARCHAR2(255) DEFAULT '소개글이 없습니다.',
    "GRADE"     NUMBER        DEFAULT 0 NOT NULL,
    CONSTRAINT "PK_TB_BLOG" PRIMARY KEY ("MEMBER_ID"),
