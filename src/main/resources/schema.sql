...
(
    ...
    FOREIGN KEY (FOLLOWER_BLOG_ID) REFERENCES TB_BLOG (BLOG_ID) ON DELETE CASCADE,
    FOREIGN KEY (FOLLOWED_BLOG_ID) REFERENCES TB_BLOG (BLOG_ID) ON DELETE CASCADE
);
...
BEGIN
    INSERT INTO TB_BLOG
    VALUES (SEQ_BLOG_ID.NEXTVAL, :NEW.MEMBER_ID, '환영합니다', 0);
END;
/