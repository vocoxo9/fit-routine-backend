...
DROP SEQUENCE SEQ_BOARD_ID;
DROP SEQUENCE SEQ_MEMBER_DETAIL_ID;
DROP SEQUENCE SEQ_FOLLOW_ID;
DROP SEQUENCE SEQ_MEMBER_DETAIL_ID;
...
(
    ...
    FOREIGN KEY (FOLLOWED_MEMBER_ID) REFERENCES TB_MEMBER (MEMBER_ID) ON DELETE CASCADE,
    FOREIGN KEY (FOLLOWER_MEMBER_ID) REFERENCES TB_MEMBER (MEMBER_ID) ON DELETE CASCADE
);

CREATE TABLE TB_MEMBER_DETAIL
(
    MEMBER_DETAIL_ID NUMBER NOT NULL,
    MEMBER_ID        NUMBER NOT NULL,
...
CREATE SEQUENCE SEQ_BOARD_LIKE_ID NOCACHE;
CREATE SEQUENCE SEQ_IMAGE_ID NOCACHE;
CREATE SEQUENCE SEQ_BOARD_ID NOCACHE;
CREATE SEQUENCE SEQ_MEMBER_DETAIL_ID NOCACHE;
CREATE SEQUENCE SEQ_FOLLOW_ID NOCACHE;
CREATE SEQUENCE SEQ_MEMBER_DETAIL_ID NOCACHE;
